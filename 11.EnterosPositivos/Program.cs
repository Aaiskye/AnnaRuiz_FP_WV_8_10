namespace _11.EnterosPositivos
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Sumatoria de números positivos (ingrese un número negativo para finalizar): ");
            numero = int.Parse(Console.ReadLine());

            while (numero >= 0)
            {
                suma += numero;
                Console.WriteLine("Siguiente número entero positivo (ingrese un número negativo para finalizar): ");
                numero = int.Parse(Console.ReadLine());
            }
